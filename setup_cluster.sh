...
# --- Step 10: Build Apptainer container ---
echo ""
echo "[10] Building Apptainer container..."
echo "  This bundles all Python deps into a container image, avoiding"
echo "  slow CVMFS imports on compute nodes."
bash "$INSTALL_DIR/containers/build.sh"
...
echo ""
echo "Next steps:"
echo "  1. Run feature extraction:  bash run_feature_extraction.sh 02:00:00"
